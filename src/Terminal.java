...
/**
 * La classe Terminal permet de r�aliser ses premiers programmes Java en
 * permettant d'afficher dans la console d'ex�cution des donn�es de type
 * diff�rents, et en permettant de saisir au clavier des donn�es de type
 * diff�rents.<BR>
...
public class Terminal {
    ...
    /**
     * Cette m�thode lit un fichier texte et retourne le contenu du fichier sous la
     * forme d'un tableau de String dont chaque element est une ligne du fichier.
     *
     * @param nomFichier le nom du fichier qui doit �tre dans le r�pertoire courant.
     * @return String[] le contenu du fichier.
     * @exception TerminalException (de type RuntimeException) si erreur
     *                              d'�criture<BR>
     *                              Rappel : Une exception de type RuntimeException
     *                              n'a pas l'obligation d'�tre captur�e.
     */
    ...
    /**
     * Cette m�thode permet de cr�er un fichier texte � partir du contenu d'un
     * StringBuffer.
     *
     ...
     * @exception TerminalException (de type RuntimeException) si la saisie n'est
     *                              pas un entier ou erreur de lecture
     */
     ...
     * @exception TerminalException (de type RuntimeException) si erreur de lecture.
     *                              <BR>
     *                              Tout autre valeur que TRUE, FALSE, true ou
     *                              false, retourne la valeur false
     */
     ...
     * @exception TerminalException (de type RuntimeException) si la valeur saisie
     *                              n'est pas un double ou ereur de lecture.
     */
     ...
     *
     * @exception TerminalException (de type RuntimeException) si erreur de
     *                              lecture.<BR>
     *                              Si on saisit plus d'1 caract�re alors le
     *                              caract�re retourn� est le premier.
     */
...
/**
 * Classe de d�finition de l'exception TerminalException qui peut �tre retourn�e
 * dans l'usage des m�thodes de la classe Terminal.
 */
